...
; CHECK-SPIRV: %[[TypeImage:[0-9]+]] = OpTypeImage
; CHECK-SPIRV-NOT: OpTypeImage
; CHECK-SPIRV: %{{[0-9]*}} = OpTypeFunction %{{[0-9]*}} %[[TypeImage]]
; CHECK-SPIRV: %{{[0-9]*}} = OpTypeFunction %{{[0-9]*}} %[[TypeImage]]
; CHECK-SPIRV: %{{[0-9]*}} = OpFunctionParameter %[[TypeImage]]
; CHECK-SPIRV: %{{[0-9]*}} = OpFunctionParameter %[[TypeImage]]
; CHECK-SPIRV: %[[ParamID:[0-9]+]] = OpFunctionParameter %[[TypeImage]]
; CHECK-SPIRV: %{{[0-9]*}} = OpFunctionCall %{{[0-9]*}} %{{[0-9]*}} %[[ParamID]]
