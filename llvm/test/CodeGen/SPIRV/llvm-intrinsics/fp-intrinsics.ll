...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] ceil
; CHECK: OpFunctionEnd
...
; CHECK: %[[n:[0-9]+]] = OpFunctionParameter %{{[0-9]+}}
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] pown %[[x]] %[[n]]
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] sin
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] cos
; CHECK: OpFunctionEnd
...
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] pow %[[x]] %[[y]]
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] exp
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] exp2
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] log
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] log10
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] log2
; CHECK: OpFunctionEnd
...
; CHECK: %[[x:[0-9]+]] = OpFunctionParameter %{{[0-9]+}}
; CHECK: %[[y:[0-9]+]] = OpFunctionParameter %{{[0-9]+}}
; CHECK: %[[res:[0-9]+]] = OpExtInst %{{[0-9]+}} %{{[0-9]+}} fmin %[[x]] %[[y]]
...
; CHECK: %[[x:[0-9]+]] = OpFunctionParameter %{{[0-9]+}}
; CHECK: %[[y:[0-9]+]] = OpFunctionParameter %{{[0-9]+}}
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] copysign %[[x]] %[[y]]
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] floor
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] trunc
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] rint
; CHECK: OpFunctionEnd
...
; CHECK: OpFunction
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] round
; CHECK: OpFunctionEnd
...
; CHECK: %[[x:[0-9]+]] = OpFunctionParameter %{{[0-9]+}}
; CHECK: %[[y:[0-9]+]] = OpFunctionParameter %{{[0-9]+}}
; CHECK: %[[z:[0-9]+]] = OpFunctionParameter %{{[0-9]+}}
; CHECK: %{{[0-9]+}} = OpExtInst %[[var1]] %[[extinst_id]] fma %[[x]] %[[y]] %[[z]]
; CHECK: OpFunctionEnd
