...
; CHECK: OpName %[[di:[0-9]+]] "div"
; CHECK: OpName %[[su:[0-9]+]] "sub"
; CHECK: OpName %[[mu:[0-9]+]] "mul"

; CHECK-NOT: OpDecorate %{{[0-9]+}} FPRoundingMode

; CHECK-DAG: OpDecorate %[[ad]] FPRoundingMode RTE
; CHECK-DAG: OpDecorate %[[di]] FPRoundingMode RTZ
; CHECK-DAG: OpDecorate %[[su]] FPRoundingMode RTP
; CHECK-DAG: OpDecorate %[[mu]] FPRoundingMode RTN
...
; CHECK: OpFMul
; CHECK: OpFAdd
; CHECK: %{{[0-9]+}} = OpExtInst %{{[0-9]+}} %{{[0-9]+}} fma
; CHECK: OpFRem
