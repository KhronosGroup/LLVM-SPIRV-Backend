...
; CHECK-SPIRV: OpName %[[NAME_FSHL_FUNC_32:[0-9]+]] "spirv.llvm_fshl_i32"
...
entry:
  ; CHECK-SPIRV: %[[CALL_32_X_Y:[0-9]+]] = OpFunctionCall %[[TYPE_INT_32]] %[[NAME_FSHL_FUNC_32]] %[[X]] %[[Y]] %[[CONST_ROTATE_32]]
  %0 = call i32 @llvm.fshl.i32(i32 %x, i32 %y, i32 8)
  ; CHECK-SPIRV: %[[CALL_32_Y_X:[0-9]+]] = OpFunctionCall %[[TYPE_INT_32]] %[[NAME_FSHL_FUNC_32]] %[[Y]] %[[X]] %[[CONST_ROTATE_32]]
...
entry:
  ; CHECK-SPIRV: %[[CALL_16:[0-9]+]] = OpFunctionCall %[[TYPE_INT_16]] %[[NAME_FSHL_FUNC_16]] %[[X]] %[[Y]] %[[CONST_ROTATE_16]]
...
entry:
  ; CHECK-SPIRV: %[[CALL_VEC_INT_16:[0-9]+]] = OpFunctionCall %[[TYPE_VEC_INT_16]] %[[NAME_FSHL_FUNC_VEC_INT_16]] %[[X]] %[[Y]] %[[CONST_ROTATE_VEC_INT_16]]
...
; CHECK-SPIRV: %[[X_FSHL:[0-9]+]] = OpFunctionParameter %[[TYPE_VEC_INT_16]]
; CHECK-SPIRV: %[[Y_FSHL:[0-9]+]] = OpFunctionParameter %[[TYPE_VEC_INT_16]]
