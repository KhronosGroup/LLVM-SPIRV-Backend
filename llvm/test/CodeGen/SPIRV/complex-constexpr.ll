...
; CHECK-SPIRV: %[[Int_Ty:[0-9]+]] = OpTypeInt 8 0
; CHECK-SPIRV: %[[Void_Ty:[0-9]+]] = OpTypeVoid
; CHECK-SPIRV: %[[Func_Ty1:[0-9]+]] = OpTypeFunction %[[Void_Ty]]
; CHECK-SPIRV: %[[Ptr_Ty:[0-9]+]] = OpTypePointer Generic %[[Int_Ty]]
; CHECK-SPIRV: %[[Func_Ty2:[0-9]+]] = OpTypeFunction %[[Void_Ty]] %[[Ptr_Ty]] %[[Ptr_Ty]]
...
; CHECK-SPIRV: %{{[0-9]+}} = OpFunctionCall %[[Void_Ty]] %[[Func:[0-9]+]] %[[Gep]] %[[Sel]]
...
; CHECK-SPIRV: %[[Func]] = OpFunction %[[Void_Ty]] None %[[Func_Ty2]]
