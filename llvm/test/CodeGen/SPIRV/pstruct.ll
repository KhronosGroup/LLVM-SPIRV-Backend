...
; CHECK-SPIRV: %[[a1:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t3]] %[[zero]]
...
; CHECK-SPIRV: %[[a2:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t4]] %[[zero]]
...
; CHECK-SPIRV: %[[a_1:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t5]] %[[zero]]
...
; CHECK-SPIRV: %[[a_2:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t6]] %[[zero]]
...
; CHECK-SPIRV: %[[b1:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t7]] %[[one]]
...
; CHECK-SPIRV: %[[b2:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t8]] %[[one]]
...
; CHECK-SPIRV: %[[b_1:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t9]] %[[one]]
...
; CHECK-SPIRV: %[[b_2:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t10]] %[[one]]
...
; CHECK-SPIRV: %[[c1:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t11]] %[[two]]
...
; CHECK-SPIRV: %[[c2:[0-9]+]] = OpInPtrBoundsAccessChain %[[intP]] %[[t12]] %[[two]]
