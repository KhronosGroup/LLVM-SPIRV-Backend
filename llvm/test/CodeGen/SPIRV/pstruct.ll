...
; CHECK-SPIRV: %[[a1:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t3]] %[[zero]] %[[zero]]
...
; CHECK-SPIRV: %[[a2:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t4]] %[[zero]] %[[zero]]
...
; CHECK-SPIRV: %[[a_1:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t5]] %[[zero]] %[[zero]]
...
; CHECK-SPIRV: %[[a_2:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t6]] %[[zero]] %[[zero]]
...
; CHECK-SPIRV: %[[b1:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t7]] %[[zero]] %[[one]]
...
; CHECK-SPIRV: %[[b2:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t8]] %[[zero]] %[[one]]
...
; CHECK-SPIRV: %[[b_1:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t9]] %[[zero]] %[[one]]
...
; CHECK-SPIRV: %[[b_2:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t10]] %[[zero]] %[[one]]
...
; CHECK-SPIRV: %[[c1:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t11]] %[[zero]] %[[two]]
...
; CHECK-SPIRV: %[[c2:[0-9]+]] = OpInBoundsPtrAccessChain %[[intP]] %[[t12]] %[[zero]] %[[two]]
