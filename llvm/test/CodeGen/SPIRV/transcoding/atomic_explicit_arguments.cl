// RUN: clang -cc1 -nostdsysteminc -triple spir -cl-std=cl2.0 %s -finclude-default-header -emit-llvm -o - | sed -Ee 's#target triple = "spir"#target triple = "spirv32-unknown-unknown"#' | llc -O0 -o - | FileCheck %s --check-prefix=CHECK-SPIRV
