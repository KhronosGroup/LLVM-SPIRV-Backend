...
; CHECK-SPIRV: %[[Header:[0-9]+]] = OpLabel
  %0 = load i32, i32* %i, align 4
  %cmp = icmp slt i32 %0, 1024
; Per SPIRV spec p3.23 "DontUnroll" loop control = 0x2
; FIXME: LoopMerge's format
; CHECK-SPIRV: OpLoopMerge %[[MergeBlock:[0-9]+]] %[[ContinueTarget:[0-9]+]] 2
; CHECK-SPIRV: OpBranchConditional %{{[0-9]+}} %{{[0-9]+}} %[[MergeBlock]]
...
; CHECK-SPIRV: %[[ContinueTarget]] = OpLabel
...
; FIXME: LoopMerge's format
; CHECK-SPIRV: OpLoopMerge %[[MergeBlock:[0-9]+]] %[[ContinueTarget:[0-9]+]] 256 8
; CHECK-SPIRV: OpBranchConditional %{{[0-9]+}} %{{[0-9]+}} %[[MergeBlock]]
...
; Per SPIRV spec p3.23 "Unroll" loop control = 0x1
; FIXME: LoopMerge's format
; CHECK-SPIRV: OpLoopMerge %[[MergeBlock:[0-9]+]] %[[ContinueTarget:[0-9]+]] 1
...
; CHECK-SPIRV: OpBranchConditional %{{[0-9]+}} %[[Header]] %[[MergeBlock]]
