...
source_filename = "sub_group_barrier.cl"
...
; CHECK-SPIRV: OpControlBarrier %[[SCOPE_SUBGROUP]] %[[SCOPE_WORK_GROUP]] %[[IMAGE]]
; CHECK-SPIRV: OpControlBarrier %[[SCOPE_SUBGROUP]] %[[SCOPE_WORK_GROUP]] %[[LOCAL_GLOBAL]]
; CHECK-SPIRV: OpControlBarrier %[[SCOPE_SUBGROUP]] %[[SCOPE_WORK_GROUP]] %[[LOCAL_IMAGE]]
; CHECK-SPIRV: OpControlBarrier %[[SCOPE_SUBGROUP]] %[[SCOPE_WORK_GROUP]] %[[LOCAL_GLOBAL_IMAGE]]
...
entry:
  tail call spir_func void @_Z17sub_group_barrierj(i32 noundef 1) #3
  tail call spir_func void @_Z17sub_group_barrierj(i32 noundef 2) #3
  tail call spir_func void @_Z17sub_group_barrierj(i32 noundef 4) #3
  tail call spir_func void @_Z17sub_group_barrierj(i32 noundef 3) #3
  tail call spir_func void @_Z17sub_group_barrierj(i32 noundef 5) #3
  tail call spir_func void @_Z17sub_group_barrierj(i32 noundef 7) #3
  tail call spir_func void @_Z17sub_group_barrierj12memory_scope(i32 noundef 1, i32 noundef 0) #3
  tail call spir_func void @_Z17sub_group_barrierj12memory_scope(i32 noundef 1, i32 noundef 1) #3
  tail call spir_func void @_Z17sub_group_barrierj12memory_scope(i32 noundef 1, i32 noundef 2) #3
  tail call spir_func void @_Z17sub_group_barrierj12memory_scope(i32 noundef 1, i32 noundef 3) #3
  tail call spir_func void @_Z17sub_group_barrierj12memory_scope(i32 noundef 1, i32 noundef 4) #3
  ret void
}

; Function Attrs: convergent
declare spir_func void @_Z17sub_group_barrierj(i32 noundef) local_unnamed_addr #1

; Function Attrs: convergent
declare spir_func void @_Z17sub_group_barrierj12memory_scope(i32 noundef, i32 noundef) local_unnamed_addr #1
