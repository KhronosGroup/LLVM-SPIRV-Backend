...
entry:
  tail call spir_func void @_Z7barrierj(i32 noundef 1) #3
  tail call spir_func void @_Z7barrierj(i32 noundef 2) #3
  tail call spir_func void @_Z7barrierj(i32 noundef 4) #3
  tail call spir_func void @_Z7barrierj(i32 noundef 3) #3
  tail call spir_func void @_Z7barrierj(i32 noundef 5) #3
  tail call spir_func void @_Z7barrierj(i32 noundef 7) #3
  ret void
}
...
define dso_local spir_kernel void @test_barrier_non_const_flags(i32 noundef %flags) local_unnamed_addr #2 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !7 !kernel_arg_type_qual !8 {
entry:
  ret void
}
