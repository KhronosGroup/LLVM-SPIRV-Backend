// RUN: clang -cc1 -nostdsysteminc -triple spir-unknown-unknown -O1 -cl-std=CL2.0 -finclude-default-header -emit-llvm %s -o - | sed -Ee 's#target triple = "spir-unknown-unknown"#target triple = "spirv32-unknown-unknown"#' | llc -O0 -o - | FileCheck %s --check-prefix=CHECK-SPIRV
