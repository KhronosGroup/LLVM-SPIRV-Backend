...
; CHECK-SPIRV-DAG: %[[long_0:[0-9]+]] = OpConstantNull %[[long]]
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[char3]] %[[ScopeSubgroup]] %[[char3_0]] %[[int_0]]
; CHECK-SPIRV: %[[char4_0:[0-9]+]] = OpVectorShuffle %[[char4]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[char4]] %[[ScopeSubgroup]] %[[char4_0]] %[[int_0]]
; CHECK-SPIRV: %[[char8_0:[0-9]+]] = OpVectorShuffle %[[char8]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[char8]] %[[ScopeSubgroup]] %[[char8_0]] %[[int_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpVectorShuffle %[[char16]]
; CHECK-SPIRV: %[[char16_0:[0-9]+]] = OpVectorShuffle %[[char16]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[char16]] %[[ScopeSubgroup]] %[[char16_0]] %[[int_0]]
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[short3]] %[[ScopeSubgroup]] %[[short3_0]] %[[int_0]]
; CHECK-SPIRV: %[[short4_0:[0-9]+]] = OpVectorShuffle %[[short4]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[short4]] %[[ScopeSubgroup]] %[[short4_0]] %[[int_0]]
; CHECK-SPIRV: %[[short8_0:[0-9]+]] = OpVectorShuffle %[[short8]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[short8]] %[[ScopeSubgroup]] %[[short8_0]] %[[int_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpVectorShuffle %[[short16]]
; CHECK-SPIRV: %[[short16_0:[0-9]+]] = OpVectorShuffle %[[short16]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[short16]] %[[ScopeSubgroup]] %[[short16_0]] %[[int_0]]
; CHECK-SPIRV: OpFunctionEnd
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[int3]] %[[ScopeSubgroup]] %[[int3_0]] %[[int_0]]
; CHECK-SPIRV: %[[int4_0:[0-9]+]] = OpVectorShuffle %[[int4]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[int4]] %[[ScopeSubgroup]] %[[int4_0]] %[[int_0]]
; CHECK-SPIRV: %[[int8_0:[0-9]+]] = OpVectorShuffle %[[int8]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[int8]] %[[ScopeSubgroup]] %[[int8_0]] %[[int_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpVectorShuffle %[[int16]]
; CHECK-SPIRV: %[[int16_0:[0-9]+]] = OpVectorShuffle %[[int16]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[int16]] %[[ScopeSubgroup]] %[[int16_0]] %[[int_0]]
; CHECK-SPIRV: OpFunctionEnd
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[long3]] %[[ScopeSubgroup]] %[[long3_0]] %[[int_0]]
; CHECK-SPIRV: %[[long4_0:[0-9]+]] = OpVectorShuffle %[[long4]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[long4]] %[[ScopeSubgroup]] %[[long4_0]] %[[int_0]]
; CHECK-SPIRV: %[[long8_0:[0-9]+]] = OpVectorShuffle %[[long8]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[long8]] %[[ScopeSubgroup]] %[[long8_0]] %[[int_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpVectorShuffle %[[long16]]
; CHECK-SPIRV: %[[long16_0:[0-9]+]] = OpVectorShuffle %[[long16]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[long16]] %[[ScopeSubgroup]] %[[long16_0]] %[[int_0]]
; CHECK-SPIRV: OpFunctionEnd
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[float3]] %[[ScopeSubgroup]] %[[float3_0]] %[[int_0]]
; CHECK-SPIRV: %[[float4_0:[0-9]+]] = OpVectorShuffle %[[float4]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[float4]] %[[ScopeSubgroup]] %[[float4_0]] %[[int_0]]
; CHECK-SPIRV: %[[float8_0:[0-9]+]] = OpVectorShuffle %[[float8]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[float8]] %[[ScopeSubgroup]] %[[float8_0]] %[[int_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpVectorShuffle %[[float16]]
; CHECK-SPIRV: %[[float16_0:[0-9]+]] = OpVectorShuffle %[[float16]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[float16]] %[[ScopeSubgroup]] %[[float16_0]] %[[int_0]]
; CHECK-SPIRV: OpFunctionEnd
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[half3]] %[[ScopeSubgroup]] %[[half3_0]] %[[int_0]]
; CHECK-SPIRV: %[[half4_0:[0-9]+]] = OpVectorShuffle %[[half4]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[half4]] %[[ScopeSubgroup]] %[[half4_0]] %[[int_0]]
; CHECK-SPIRV: %[[half8_0:[0-9]+]] = OpVectorShuffle %[[half8]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[half8]] %[[ScopeSubgroup]] %[[half8_0]] %[[int_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpVectorShuffle %[[half16]]
; CHECK-SPIRV: %[[half16_0:[0-9]+]] = OpVectorShuffle %[[half16]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[half16]] %[[ScopeSubgroup]] %[[half16_0]] %[[int_0]]
; CHECK-SPIRV: OpFunctionEnd
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[double3]] %[[ScopeSubgroup]] %[[double3_0]] %[[int_0]]
; CHECK-SPIRV: %[[double4_0:[0-9]+]] = OpVectorShuffle %[[double4]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[double4]] %[[ScopeSubgroup]] %[[double4_0]] %[[int_0]]
; CHECK-SPIRV: %[[double8_0:[0-9]+]] = OpVectorShuffle %[[double8]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[double8]] %[[ScopeSubgroup]] %[[double8_0]] %[[int_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpVectorShuffle %[[double16]]
; CHECK-SPIRV: %[[double16_0:[0-9]+]] = OpVectorShuffle %[[double16]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupBroadcast %[[double16]] %[[ScopeSubgroup]] %[[double16_0]] %[[int_0]]
; CHECK-SPIRV: OpFunctionEnd
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupIAdd %[[char]] %[[ScopeSubgroup]] InclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupSMin %[[char]] %[[ScopeSubgroup]] InclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupSMax %[[char]] %[[ScopeSubgroup]] InclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupIAdd %[[char]] %[[ScopeSubgroup]] ExclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupSMin %[[char]] %[[ScopeSubgroup]] ExclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupSMax %[[char]] %[[ScopeSubgroup]] ExclusiveScan %[[char_0]]
; CHECK-SPIRV: OpFunctionEnd
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupIAdd %[[char]] %[[ScopeSubgroup]] InclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupUMin %[[char]] %[[ScopeSubgroup]] InclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupUMax %[[char]] %[[ScopeSubgroup]] InclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupIAdd %[[char]] %[[ScopeSubgroup]] ExclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupUMin %[[char]] %[[ScopeSubgroup]] ExclusiveScan %[[char_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupUMax %[[char]] %[[ScopeSubgroup]] ExclusiveScan %[[char_0]]
; CHECK-SPIRV: OpFunctionEnd
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupIAdd %[[short]] %[[ScopeSubgroup]] InclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupSMin %[[short]] %[[ScopeSubgroup]] InclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupSMax %[[short]] %[[ScopeSubgroup]] InclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupIAdd %[[short]] %[[ScopeSubgroup]] ExclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupSMin %[[short]] %[[ScopeSubgroup]] ExclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupSMax %[[short]] %[[ScopeSubgroup]] ExclusiveScan %[[short_0]]
; CHECK-SPIRV: OpFunctionEnd
...
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupIAdd %[[short]] %[[ScopeSubgroup]] InclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupUMin %[[short]] %[[ScopeSubgroup]] InclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupUMax %[[short]] %[[ScopeSubgroup]] InclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupIAdd %[[short]] %[[ScopeSubgroup]] ExclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupUMin %[[short]] %[[ScopeSubgroup]] ExclusiveScan %[[short_0]]
; CHECK-SPIRV: %{{[0-9]+}} = OpGroupUMax %[[short]] %[[ScopeSubgroup]] ExclusiveScan %[[short_0]]
; CHECK-SPIRV: OpFunctionEnd
