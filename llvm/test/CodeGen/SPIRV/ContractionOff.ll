...
; RUN: llc -O0 %s -o - | FileCheck %s --check-prefixes=CHECK,CHECK-ON,CHECK-OFF,CHECK-FAST

; CHECK: OpEntryPoint Kernel %[[K1:[0-9]+]] "k1"
; CHECK: OpEntryPoint Kernel %[[K2:[0-9]+]] "k2"
; CHECK: OpEntryPoint Kernel %[[K3:[0-9]+]] "k3"

; CHECK-OFF: OpExecutionMode %[[K1]] ContractionOff
; CHECK-OFF: OpExecutionMode %[[K2]] ContractionOff
; CHECK-OFF: OpExecutionMode %[[K3]] ContractionOff

; CHECK-FAST-NOT: OpExecutionMode %[[K1]] ContractionOff
; CHECK-FAST-NOT: OpExecutionMode %[[K2]] ContractionOff
; CHECK-FAST-NOT: OpExecutionMode %[[K3]] ContractionOff

; CHECK-ON: OpExecutionMode %[[K1]] ContractionOff
; CHECK-ON-NOT: OpExecutionMode %[[K2]] ContractionOff
; CHECK-ON: OpExecutionMode %[[K3]] ContractionOff
